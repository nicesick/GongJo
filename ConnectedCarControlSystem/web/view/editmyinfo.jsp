						...
						<div class="row p-b-20">
							<div class="col-12">
								...
								<div class="input-group mb-2">
									...
									<!-- <input type="text" id="user_id" name="user_id" class="form-control" placeholder="아이디" aria-label="Username" aria-describedby="basic-addon1"> -->
								</div>
								...
								<div class="input-group mb-2">
									...
									<input type="password" id="user_new_pwd_check"
										name="new_pwd_check" class="form-control"
