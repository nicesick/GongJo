        ...
        <header class="topbar" data-navbarbg="skin5">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <!-- Logo -->
                    <!-- ============================================================== -->
                    <a class="navbar-brand" href="main.mc">
                        <!-- Logo icon -->
                        ...
                        <!--End Logo icon -->
                         <!-- Logo text -->
                        <span class="logo-text waves-effect waves-dark">
                             <!-- dark Logo text -->
                             CCCS
                        </span>
                        <!-- Logo icon -->
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                             <span class="d-none d-md-block">Select Car <i class="fa fa-angle-down"></i></span>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="getConsumableData.mc" aria-expanded="false"><i class="mdi mdi-chart-bar"></i><span class="hide-menu">차량 정보</span></a></li>
