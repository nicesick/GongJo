                        ...
                        <div class="row border-top border-secondary">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="mb-12 p-t-20">
                                        <button id="registerButton" class="btn btn-block btn-lg btn-info" type="button">Sign Up</button>
                                    </div>
                                    <div class="mb-12 p-t-20">
                                        <button id="backButton" class="btn btn-block btn-lg btn-info" type="button">Back</button>
                                    </div>
                                </div>
                            </div>
                        </div>
