...
//					}
	...
	public void connectSerial() throws Exception {
		...
		if (portIdentifier.isCurrentlyOwned()) {
			System.out.println("Error: Port is currently in use"); // �׷��������� ������ ��������, �ٸ� ����� ���� �ִ�.
		} else {
			...
			if (commPort instanceof SerialPort) {
				...
				serialPort.setSerialPortParams(921600, // ��żӵ�
						...
						SerialPort.PARITY_NONE); // �и�Ƽ �츮�� �����ϴ°� ���� �ϰڴ� .
	...
	private class SerialWriter implements Runnable {
		...
		public SerialWriter() {
			this.data = ":G11A9\r"; // ���� ���� ���� �ϰڽ��ϴ� .
		}

		public SerialWriter(String serialData) {
			// W28 00000000 000000000000
			// :W28 00000000 000000000000 53 \r : \r ���۰� �� 53 üũ��
